...
const selectedLocations = params.get("jenis_lokasi")
  ? params.get("jenis_lokasi").split(",")
  : [];
const selectedTypes = params.get("jenis_pekerjaan")
  ? params.get("jenis_pekerjaan").split(",")
  : [];
...
document
  .querySelectorAll('input[name="location"], input[name="type"]')
  .forEach((checkbox) => {

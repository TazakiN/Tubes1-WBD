...
(9, 1, 'uploads/cv.pdf', '/videos/ahmad/intro.mp4', 'Memiliki pengalaman 6 tahun dalam Java development.', 'accepted', 'Pengalaman dan skills match dengan kebutuhan tim.'),
(10, 1, 'uploads/cv.pdf', NULL, 'Berpengalaman dengan Spring Boot dan microservices.', 'rejected', 'Kurang pengalaman dalam skala enterprise.'),
(11, 2, 'uploads/cv.pdf', '/videos/budi/profile.mp4', 'Familiar dengan AWS dan Docker.', 'waiting', NULL),
(12, 3, 'uploads/cv.pdf', NULL, 'Passionate dalam AI dan machine learning.', 'accepted', 'Background akademis yang kuat dan pengalaman relevant.'),
(13, 4, 'uploads/cv.pdf', NULL, 'Berpengalaman dengan React dan TypeScript.', 'waiting', NULL),
(14, 5, 'uploads/cv.pdf', '/videos/nina/intro.mp4', 'Background dalam business analysis.', 'rejected', 'Kurang pengalaman dalam proyek teknologi.'),
(15, 6, 'uploads/cv.pdf', NULL, 'Berpengalaman dalam automated testing.', 'accepted', 'Skills teknis yang sesuai dengan kebutuhan.'),
(16, 7, 'uploads/cv.pdf', NULL, 'Portfolio aplikasi Flutter yang impressive.', 'waiting', NULL),
(17, 8, 'uploads/cv.pdf', '/videos/dani/portfolio.mp4', 'Portfolio desain UI/UX yang kreatif.', 'accepted', 'Portfolio menunjukkan kreativitas dan kemampuan teknis yang baik.'),
(18, 9, 'uploads/cv.pdf', NULL, 'Familiar dengan Node.js dan Express.', 'waiting', NULL),
(19, 10, 'uploads/cv.pdf', NULL, 'Pengalaman product management 3 tahun.', 'rejected', 'Kurang pengalaman dalam produk teknologi.'),
(20, 11, 'uploads/cv.pdf', '/videos/anisa/intro.mp4', 'Background dalam data science dan statistik.', 'waiting', NULL),
(9, 12, 'uploads/cv_2.pdf', NULL, 'Familiar dengan PowerBI dan SQL.', 'waiting', NULL),
(11, 13, 'uploads/cv_2.pdf', NULL, 'Berpengalaman dengan AWS architecture.', 'accepted', 'Pengalaman yang relevan dan sertifikasi AWS.'),
(13, 14, 'uploads/cv_2.pdf', NULL, 'Pengalaman support di perusahaan IT.', 'waiting', NULL),
(15, 15, 'uploads/cv_2.pdf', '/videos/farhan/portfolio.mp4', 'Portfolio web development yang kreatif.', 'waiting', NULL),
(17, 16, 'uploads/cv_2.pdf', NULL, 'Antusias belajar digital marketing.', 'accepted', 'Motivasi tinggi dan background marketing yang sesuai.'),
(19, 3, 'uploads/cv_2.pdf', NULL, 'Pengalaman dengan Python dan ML.', 'waiting', NULL),
(20, 5, 'uploads/cv_2.pdf', '/videos/anisa/profile.mp4', 'Portfolio data analysis yang menarik.', 'waiting', NULL);